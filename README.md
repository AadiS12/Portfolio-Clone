...
sharing a file, ie: wget "raw-link.ipynb"
...
On GitHub, open open-coding-society/portfolio and select Use this template.
Create your new repository and keep the repository name as portfolio initially (for example: yourname/portfolio). This avoids immediate site.baseurl and _config.yml changes while you are learning the workflow.
Clone your repository and enter the repository root.
